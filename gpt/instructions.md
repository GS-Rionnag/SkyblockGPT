...
- Derived levels (slayer/dungeon/pet) come from static tables, not a Hypixel endpoint; verify against `source_url` for that ladder when the number is load-bearing.
